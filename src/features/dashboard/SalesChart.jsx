  ...
  const data = allDates.map((date) => {
    return {
      ...
      totalSales: bookings
        ...
        .reduce((start, cur) => cur.totalPrice + start, 0),
      extrasSales: bookings
        .filter((bookings) => isSameDay(date, new Date(bookings.created_at)))
        .reduce((start, cur) => cur.extrasPrice + start, 0)
    };
  });
  console.log(data);

  console.log("DAY: ", allDates, "numDays: ", numDays);
  console.log(bookings[0]);
  console.log(new Date(bookings[0].created_at));
